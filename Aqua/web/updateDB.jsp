...
<html>
    ...
    <body>
        ...
        try { 
            ...
            String prev_title = (String)hSession.getAttribute("prev_title"); // retrieving the title from the session variable ( update_page.jsp )
